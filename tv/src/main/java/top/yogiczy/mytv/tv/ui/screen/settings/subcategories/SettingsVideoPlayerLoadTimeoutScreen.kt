...
fun SettingsVideoPlayerLoadTimeoutScreen(
    ...
    AppScreen(
        ...
        header = { Text("${stringResource(R.string.ui_dashboard_module_settings)} / ${stringResource(R.string.ui_channel_view_player)} / ${stringResource(R.string.ui_player_view_load_timeout)}") },
        canBack = true,
