...
fun SettingsUiFontScaleRatioScreen(
    ...
    AppScreen(
        ...
        header = { Text("${stringResource(R.string.ui_dashboard_module_settings)} / ${stringResource(R.string.ui_channel_view_interface)} / ${stringResource(R.string.ui_font_scale_ratio)}") },
        canBack = true,
